...
globals
  ...
  cor
  in-immune
]  ;; if the simulation is ended because no one is sick
...
to setup-turtles
  ...
  if get-vaccine = "30%" [set in-immune (30 * initial-number-people) / 100]
  if get-vaccine = "50%" [set in-immune (50 * initial-number-people) / 100]
  if get-vaccine = "70%" [set in-immune (70 * initial-number-people) / 100]
  ask n-of in-immune turtles
  [ become-immune ]
